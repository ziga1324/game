...
class Game:
    def __init__(self):
        ...
        self.screen=pygame.display.set_mode((1040, 860))
        ...
        self.assets = {
                ...
                "background": load_image("ozadje.png"),
                ...
                'particle/leaf': Animation(load_images('tiles/particles/leaf'), img_dur=20, loop= False),
                'particle/particle': Animation(load_images('tiles/particles/particle'), img_dur=6, loop= False),
